...
public class VectorTests {
    ...
    public void additionTest() {
        ...
        vector1.add(vector2);
        Assertions.assertEquals("{12.0, 57.0, 12.4, 18.3, 23.0, 45.0, 3.0}", vector1.toString());
    }
    ...
    public void subtractionTest() {
        ...
        Assertions.assertEquals("{-10.0, -47.0, -10.5, -8.3, 23.0, 45.0, 3.0}", vector1.toString());
    }
    ...
    public void multiplicationTest() {
        ...
        Assertions.assertEquals("{2.0, 10.0, 12.0, 2.0, 46.0, 90.0, 6.0}", vector1.toString());
    }
    ...
    public void rotationTest() {
        ...
        vector.rotate();
        Assertions.assertEquals("{-1.0, -5.0, -6.0, 1.0, 23.0, -45.5, -3.0}", vector.toString());
    }
    ...
    public void scalarProductTest() {
        ...
        Assertions.assertEquals(379.3, Vector.getScalarProduct(vector1, vector2));
    }
    ...
    public void addition2Test() {
        ...
        Assertions.assertEquals("{12.0, 57.0, 22.5, 10.3, 23.0, 45.0, 3.0}", Vector.getSum(vector1, vector2).toString());
    }
    ...
    public void subtraction2Test() {
        ...
        Assertions.assertEquals("{-10.0, -47.0, -10.5, -8.0, 23.0, 45.0, 3.0}", Vector.getDifference(vector1, vector2).toString());
    }
}
