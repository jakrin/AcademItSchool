...
public class Vector {
    ...
    public Vector(double[] components) {
        if (components.length == 0) {
            throw new IllegalArgumentException("Vector size should be greater than 0. Vector size is: " + components.length);
        }
    ...
    public Vector(int vectorSize) {
        if (vectorSize <= 0) {
            throw new IllegalArgumentException("Vector size should be greater than 0. Vector size is: " + vectorSize);
        }
